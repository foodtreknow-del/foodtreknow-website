FoodTrekNow Vendor Platform - Phase 3 Menu Management

Login:
Email: vendor@foodtreknow.com
Password: demo123

New in this release:
- Full Menu Management page
- Add, edit, and delete menu items
- Item name, category, price, description, and photo upload
- Available / Sold Out controls
